...
namespace Core.Initializers.Bootstraps
{
    public class BootstrapInitializer : MonoBehaviour
    {
            ...
            LoadingScreenService  loadingScreenService)
        {
           ...
           await loadingScreenService.Show(LoadingScreenType.Dev, "Waiting for Bootstrap to complete");
           
            AddCoreStates(gameStateMachine, mainMenuStateFactory, loadGameStateFactory, gameStateFactory, unloadGameStateFactory);
